...
const publicScenarios = [
  ...
  },
  {
    ...
    args: ['--scenario=companion-agent-workbench-approval-approve-current-window', '--skip-prepare'],
  },
  {
    name: 'companion-agent-workbench-approval-reject-current-window',
    description:
      'packaged auto-open agent workbench exercises approval request/reject flow in the current window',
    args: ['--scenario=companion-agent-workbench-approval-reject-current-window', '--skip-prepare'],
  },
  {
